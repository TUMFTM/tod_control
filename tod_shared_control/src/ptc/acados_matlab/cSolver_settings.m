...
% qp solver settings,
myQPtolerence = 1e-4; % keep smaller 1e-3
qp_solver_iter_max = 100;
qp_solver_tol_stat = myQPtolerence;
qp_solver_tol_eq = myQPtolerence;
qp_solver_tol_ineq = myQPtolerence;
qp_solver_tol_comp = myQPtolerence;
